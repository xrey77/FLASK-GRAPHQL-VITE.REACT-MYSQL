...
export default function Prodsearch() {
  ...
  const [product_search] = useLazyQuery<ProductSearchData, ProductSearchVariables>(SEARCH_QUERY);
      ...
      setMessage("please wait .");
        try {
            ...
            if (data?.product_search) {
              ...
              setProdsearch(data.product_search.products);
              setTotpage(data.product_search.totpage);
              setTotalrecords(data.product_search.totalrecords);
            }            
